...
export function SettingsPlaceholder({
  ...
  return (
    <StaffPageContent>
      ...
      <div className="bg-surface rounded-xl border border-border p-8 flex flex-col items-center gap-3 text-center max-w-lg mx-auto">
        ...
        {detail && <p className="text-xs text-muted max-w-sm">{detail}</p>}
      </div>
    </StaffPageContent>
  );
}
